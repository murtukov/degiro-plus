...
!function () {
  ...
  var o, i, r, n, s, a, d, l = "-apple-system, BlinkMacSystemFont, 'Trebuchet MS', Roboto, Ubuntu, sans-serif", h = {
    ...
    css: function (e) {
      var t, o = document.getElementsByTagName("head")[0], i = document.createElement("style");
    ...
    MediumWidget: function (e) {
      ...
      switch (e.chartType) {
        ...
        case"line": {
          const {chartType: t, color: i, colorGrowing: r, colorFalling: n, lineWidth: s} = e;
          o = {chartType: t, color: i, colorGrowing: r, colorFalling: n, lineWidth: s};
          break
        }
        case"area":
        default: {
    ...
    widget: function (e) {
      this.id = e.id || h.gId();
      var t = h.getUrlParams(), o = e.tvwidgetsymbol || t.tvwidgetsymbol || t.symbol || e.symbol || "NASDAQ:AAPL",
        i = e.logo || "";
  ...
  h.WidgetAbstract.prototype = {
    fixSize: function (e) {
      ...
      var i = h.WidgetAbstract.prototype.height.call(this), r = h.WidgetAbstract.prototype.width.call(this);
      o = o || "transparent";
      ...
      var o = (t || {}).greyText || "powered by", i = (t || {}).linkText || "tradingview.com",
    ...
    createWidget: function () {
      ...
      var e = this.options.room ? "#" + encodeURIComponent(this.options.room) : "",
        t = "&" + h.createUrlParams({whotrades: this.options.whotrades, locale: this.options.locale}),
        o = h.generateUtmForUrlParams(this.options, {type: "UserInfoWidget"});
    ...
    createWidget: function () {
      ...
      var t = this, o = document.getElementById(this.id);
      ...
      var t = "&" + h.generateUtmForUrlParams(this.options), o = h.ideasHost + "/idea-popup/?" + e + t;
    ...
    createWidget: function () {
      ...
      var e = h.createUrlParams({currency: this.options.currency, importance: this.options.importance});
    ...
    createWidget: function () {
      ...
      var e = this.options, t = h.createUrlParams({
        id: this.id,
        width: e.width,
        height: e.height,
        symbol: e.symbol,
        ...
        locale: e.locale,
        useWidgetHost: Boolean(e.useWidgetHost)
      }), o = h.generateUtmForUrlParams(this.options) + "&", i = h.getHost(e) + "/ideaswidgetembed/?" + o + t;
    ...
    createWidget: function () {
      ...
      if (!t.noLogoOverlay && !t.whitelabel) {
        ...
        e = h.WidgetAbstract.prototype.addFooterLogo.call(this, e, {greyText: o, linkText: "TradingView"})
      }
      c(e, t.container)
    }, widgetCode: function () {
      var e = "", t = "", o = "", i = "/miniwidgetembed/",
      ...
      var y = function (e) {
        for (var t = [], i = 0; i < e.length; i++) {
          var r = e[i];
          if (h.isArray(r)) {
            var n = encodeURIComponent(r[0]), s = encodeURIComponent(r[1]);
            t.push(n), o += "&" + n + "=" + s
    ...
    create: function () {
      ...
      o && o.parentElement && o.parentElement.removeChild(o), this.iframe = document.getElementById(this.id), this.postMessage = h.postMessageWrapper(this.iframe.contentWindow, this.id), h.bindEvent(this.iframe, "load", (function () {
        ...
        var a = t.options.popup_width || 900, d = t.options.popup_height || 600, l = (screen.width - a) / 2,
          c = (screen.height - d) / 2,
    ...
    create: function () {
      ...
      h.chartCssAttached || (h.css(this.renderCss()), h.chartCssAttached = !0), c(t, this.options.container), e = document.getElementById(this.id), h.bindEvent(e, "load", (function () {
        ...
        var t = !1;
        if (document.querySelector && document.querySelector('a[href$="/v/' + o.options.chart + '/"]') && (t = !0), !t) for (var i = document.getElementsByTagName("a"), r = new RegExp("/v/" + o.options.chart + "/$"), n = new RegExp("/chart/([0-9a-zA-Z:+*-/()]+)/" + o.options.chart), s = 0; s < i.length; s++) if (r.test(i[s].href) || n.test(i[s].href)) {
          t = !0;
          break
        }
    ...
    }, ready: h.widget.prototype.ready, renderCss: function () {
    ...
    if (t && t.provider && "TradingView" === t.provider) if (t.source = e.source, "get" === t.type) {
      ...
      n[t.name].forEach((function (e) {
        "function" == typeof e && e.call(t, t.data, (function (e) {
          var o = {id: t.id, type: "on", name: t.name, client_id: t.client_id, data: e, provider: "TradingView"};
          i.postMessage(JSON.stringify(o), "*")
        }))
      }))
    } else if ("on" === t.type) r[t.client_id] && r[t.client_id][t.id] && (r[t.client_id][t.id].call(t, t.data), delete r[t.client_id][t.id]); else if ("post" === t.type) {
      if (!n[t.name]) return;
      n[t.name].forEach((function (e) {
    ...
    return r[t] = {}, s[t] = e, i = e, {
      on: function (e, t, o) {
        ...
        var n = {id: a++, type: "get", name: e, client_id: t, data: o, provider: "TradingView"};
        r[t][n.id] = i, s[t].postMessage(JSON.stringify(n), "*")
      }, post: function (e, t, o) {
        var i = {id: d++, type: "post", name: t, data: o, provider: "TradingView"};
